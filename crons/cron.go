...
func InitCron() {
	...
	every("15 5 * * *", func() { bot.Remind("Let's keep our streak on!!||صباح الخير مو تنسون الرياضة||") }) // 8:15 AM Baghdad time
	every("15 10 * * *", func() { bot.Act("bestStreak") })                                                  // 8:15 AM Baghdad time
